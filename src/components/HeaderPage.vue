...
<template>
  <header
    class="sticky bg-white top-0 left-0 w-full z-30 flex items-center justify-between text-white mb-8"
  >
    <div
      :class="{ 'bg-red-600 z-10': activeMenu }"
      class="flex justify-between items-center w-full border-b border-zinc-200 py-2 p-6"
    >
      <template
        v-if="
          $route.path === '/Notification' ||
          $route.path === '/compte/settings' ||
          $route.path === '/compte/CompteLangue' ||
          $route.path === '/compte/CompteDP' ||
          $route.path === '/compte/CompteAbonnement' ||
          $route.path === '/compte/ComptePersonneRencontré' ||
          $route.path === '/compte/ComptePaiement' ||
          $route.path === '/compte/CompteCG' ||
          $route.path === '/compte/ComptePC' ||
          $route.path === '/connexion' ||
          $route.path === '/coaching/recherche' ||
          $route.path === '/activite/recherche' ||
          $route.path === '/activite/CreationActivité' ||
          $route.path === '/activite/CreationGroupe' ||
      ...
      >
        <button @click="goBack">
          <flecheIcon
            class="w-10 h-6 my-3"
            :class="{ 'text-white': activeMenu, 'text-black': !activeMenu }"
          />
        </button>
      </template>
      ...
      <div class="flex items-center gap-3">
        <RouterLink to="/Notification" @click="closeMenu">
          <NotifIcon
            :class="{ 'text-white stroke-white': activeMenu, 'text-black': !activeMenu }"
          />
        </RouterLink>

        <button class="z-10"></button>
        ...
        >
          <div
            :class="{ 'translate-y-[8px] rotate-45 !bg-white': activeMenu }"
            class="rounded"
          ></div>
    ...
    <div class="flex gap-6 lg:flex-row-reverse">
      ...
      >
        <ul class="mt-[25vh] mx-10 lg:m-0 lg:flex relative z-20">
          ...
          <li class="menu-item">
            <RouterLink class="menu-link" to="/activite" @click="closeMenu">Activité</RouterLink>
          </li>
          <li class="menu-item">
            <RouterLink class="menu-link" to="/coaching" @click="closeMenu">Coaching</RouterLink>
          </li>
          <li class="menu-item">
