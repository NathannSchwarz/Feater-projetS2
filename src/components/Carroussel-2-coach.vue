...
<template>
  <div ref="carouselRef" id="carousel" class="relative w-full overflow-hidden">
    <div
      ...
      :style="{ transform: `translateX(-${currentIndex * (252 / props.coaches.length)}%)` }"
      style="scroll-snap-type: x mandatory"
    >
      <div
        v-for="coach /* index */ in props.coaches"
        :key="coach.id"
        class="w-4/5 flex-shrink-0 ms-6"
        ...
        <RouterLink :to="coach.link">
          <div class="relative flex justify-center w-80 h-44">
            <img
              ...
              :src="coach.imgCardPath"
              :alt="coach.imgAlt || coach.Nom"
            />
            <div
              class="absolute bottom-0 w-full h-2/5 text-white bg-red-500 px-3 py-2 rounded-b-xl"
            >
