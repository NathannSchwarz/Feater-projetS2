...
<template>
  <nav class="mx-10">
    ...
    <div class="flex flex-col">
      ...
      <button
        class="flex border border-gray-300 rounded-3xl px-14 p-2 text-red-600 font-bold text-center justify-center mb-10"
      >
        Mot de passe oublié
      </button>
      ...
      <p class="text-sm text-center mb-40">
        ...
        <RouterLink to="/Inscription" class="text-red-600">Inscrivez-vous</RouterLink>
      </p>
